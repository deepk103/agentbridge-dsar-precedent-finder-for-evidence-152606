...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "DSAR Precedent Finder for evidence"
    environment = "production"
    Name = "agentbridge-dsar-precedent-finder-for-evidence"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-dsar-precedent-finder-for-evidence-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-dsar-precedent-finder-for-evidence-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-dsar-precedent-finder-for-evidence-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-dsar-precedent-finder-for-evidence-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-dsar-precedent-finder-for-evidence-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-dsar-precedent-finder-for-evidence"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-dsar-precedent-finder-for-evidence-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-dsar-precedent-finder-for-evidence-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-dsar-precedent-finder-for-evidence-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-dsar-precedent-finder-for-evidence-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-dsar-precedent-finder-for-evidence-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-dsar-precedent-finder-for-evidence-flow"
